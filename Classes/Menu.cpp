    ...
    while(true) {
        ...
        switch (input) {
            case 1: {
                ...
                std::cout << "Pedido adicionado à fila\n";
            ...
            case 2: {
                ...
                Turma* turma = g->pesquisa_turma(cod_uc, cod_turma) ;
                    ...
                    g->adicionar_pedido(pedido);
                    std::cout << "Pedido adicinado à fila\n";
...
void Menu::show_pedidos(int ordem){
        ...
        for (unsigned i = 0; i < initial_size; i++) {
            ...
            if (ordem == 1) {
                if (p->get_tipo() == "Trocar"){
                    std::cout << "Pedido nº " << i+1 <<" -> "<<p->get_tipo() << ": " ;
